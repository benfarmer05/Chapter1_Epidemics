  ...
  load(here("output", "plots_obs_workspace_rewind.RData"))
  ...
  for(i in 1:length(sites)){
    ...
    control = list(itermax = 20)  # Maximum number of iterations. 200 is default
  ...
  save.image(file = here("output", "basic_SIR_workspace_rewind.RData"))
